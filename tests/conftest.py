"""
conftest.py — Shared fixtures for Callosum tests.
...
callosum imports — so that module-level initialisations (e.g.
...
# ── Isolate HOME before any callosum imports ──────────────────────────
_original_env = {}
_session_tmp = tempfile.mkdtemp(prefix="callosum_session_")
...
# Now it is safe to import callosum modules that trigger initialisation.
import chromadb  # noqa: E402
import pytest  # noqa: E402

from callosum.config import CallosumConfig  # noqa: E402
from callosum.knowledge_graph import KnowledgeGraph  # noqa: E402
...
def tmp_dir():
    ...
    d = tempfile.mkdtemp(prefix="callosum_test_")
    yield d
...
def config(tmp_dir, palace_path):
    """A CallosumConfig pointing at the temp palace."""
    ...
    return CallosumConfig(config_dir=cfg_dir)
