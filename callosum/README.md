# callosum/ — Core Package

The Python package that powers Callosum. All modules, all logic.
...
| `config.py` | Configuration loading — `~/.callosum/config.json`, env vars, defaults |
