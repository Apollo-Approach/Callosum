"""
knowledge_graph.py -- Temporal Entity-Relationship Graph for Callosum
=====================================================================
...
Usage:
    from Callosum.knowledge_graph import KnowledgeGraph
...
DEFAULT_KG_PATH = os.path.expanduser("~/.callosum/knowledge_graph.sqlite3")


class KnowledgeGraph:
    def __init__(self, db_path: str = None):
        self.db_path = db_path or DEFAULT_KG_PATH
        self._lock = threading.Lock()  # Upstream fix: KG thread safety (Callosum v3.3.1)
    ...
    def add_triple(
        ...
        Examples:
            ...
            add_triple("Alice", "worried_about", "Max injury", valid_from="2026-01", valid_to="2026-02", source="User via Telegram")
        """
        ...
        with self._lock:
            ...
            try:
                ...
                conn.execute(
                    """INSERT INTO triples (id, subject, predicate, object, valid_from, valid_to, confidence, source_closet, source_file, source)
                       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)""",
                    (
                        triple_id,
                        sub_id,
