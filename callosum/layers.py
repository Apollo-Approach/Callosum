#!/usr/bin/env python3
"""
layers.py -- 4-Layer Memory Stack for Callosum
===================================================
...
Reads directly from ChromaDB (callosum_drawers)
and ~/.callosum/identity.txt.
"""
...
class Layer0:
    ...
    Reads from ~/.callosum/identity.txt -- a plain-text file the user writes.
    ...
    def __init__(self, identity_path: str = None):
        if identity_path is None:
            identity_path = os.path.expanduser("~/.callosum/identity.txt")
    ...
    def render(self) -> str:
        ...
        if os.path.exists(self.path):
            ...
            self._text = (
                "## L0 -- IDENTITY\nNo identity configured. Create ~/.callosum/identity.txt"
            )
...
class Layer1:
    ...
    def generate(self) -> str:
        ...
        try:
            ...
            return "## L1 -- No palace found. Run: Callosum mine <dir>"
...
class Layer3:
    ...
    Reuses searcher.py logic against callosum_drawers.
    """
...
class MemoryStack:
    ...
    def __init__(self, palace_path: str = None, identity_path: str = None):
        cfg = CallosumConfig()
        self.palace_path = palace_path or cfg.palace_path
        self.identity_path = identity_path or os.path.expanduser("~/.callosum/identity.txt")
