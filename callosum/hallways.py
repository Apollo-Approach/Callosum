...
``~/.callosum/`` so the records survive across mines and are
...
logger = logging.getLogger("callosum_hallways")
...
_HALLWAY_FILE = os.path.join(os.path.expanduser("~"), ".callosum", "hallways.json")
