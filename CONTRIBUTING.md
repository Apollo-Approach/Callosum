...
Thanks for wanting to help. Callosum is open source and we welcome contributions of all sizes — from typo fixes to new features.
...
```
callosum/          ← core package (see callosum/README.md for module guide)
...
Check the [Issues](https://github.com/Apollo-Approach/Callosum/issues) tab. Great starting points:
